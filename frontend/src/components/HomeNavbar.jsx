...
const HomeNavbar = () => {
  ...
  const navLinks = [
    ...
    ...(user ? [] : [{ name: 'Dashboard', href: '/dashboard', external: true }])
  ]
  ...
  return (
    <motion.nav
      ...
      className="fixed top-0 left-0 w-full z-50 bg-slate-900 border-b-2 border-emerald-500 shadow-2xl"
    >
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 py-3">
          ...
          <div className="flex items-center">
            ...
            >
              <PromptoLogo className="text-white drop-shadow-lg" />
            </motion.div>
          </div>
          ...
          <div className="flex items-center space-x-8">
            {navLinks.map((link, index) => (
              <motion.button
                ...
                className="text-white font-medium text-base hover:text-slate-300 transition-colors duration-200"
              >
                {link.name}
              </motion.button>
            ))}
            ...
            {user ? (
              <div className="flex items-center space-x-3">
                <motion.button
                  ...
                  className="text-white font-medium px-4 py-2 text-sm border-2 border-emerald-500 rounded-lg hover:bg-emerald-500 transition-all duration-200"
                  style={{ 
                ...
                <div className="relative">
                  <motion.button
                    ...
                    className="text-white font-medium px-4 py-2 text-sm rounded-lg transition-all duration-200 shadow-lg hover:shadow-emerald-500/25 flex items-center gap-2"
                    style={{ 
                    ...
                    {isUserMenuOpen && (
                      <>
                        ...
                        <motion.div
                          ...
                          className="absolute right-0 mt-2 w-48 bg-slate-800 border-2 border-emerald-500/50 rounded-lg shadow-2xl shadow-black/50 z-50"
                          style={{ top: '100%' }}
                        >
                          <div className="p-1">
                            <motion.button
                              ...
                              className="w-full text-left px-4 py-3 text-red-400 font-medium rounded-md transition-all duration-200 flex items-center gap-2 hover:text-red-300 hover:bg-red-500/20 hover:shadow-lg"
                            >
              ...
              <>
                ...
                <motion.button
                  ...
                  className="text-white font-medium px-4 py-2 text-sm rounded-lg transition-all duration-200 shadow-lg hover:shadow-emerald-500/25"
                  style={{ 
                    backgroundColor: '#10b981',
                    border: 'none'
                  }}
      ...
      <motion.div
        ...
        className="md:hidden overflow-hidden bg-slate-900 border-t-2 border-emerald-500 shadow-2xl"
      >
        <div className="px-6 py-4 space-y-4">
              ...
              <button
                ...
                className="block w-full text-left text-white hover:text-slate-300 transition-colors duration-200 font-medium py-2 px-3"
              >
                {link.name}
              </button>
            ))}
          <div className="pt-4 border-t border-slate-700/50 space-y-3">
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              onClick={() => window.location.href = '/auth/sign-in'}
              className="w-full text-white font-medium py-2 px-3 rounded-lg transition-all duration-200"
              style={{ 
                backgroundColor: 'transparent',
